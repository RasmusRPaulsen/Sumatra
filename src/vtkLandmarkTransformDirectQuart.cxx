/*=========================================================================
  ...
  Module:    $RCSfile: vtkLandmarkTransformDirectQuart.cxx,v $
...
vtkStandardNewMacro(vtkLandmarkTransformDirectQuart);

//----------------------------------------------------------------------------
vtkLandmarkTransformDirectQuart::vtkLandmarkTransformDirectQuart()
{
...
//----------------------------------------------------------------------------
void vtkLandmarkTransformDirectQuart::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkLandmarkTransformDirectQuart::InternalUpdate()
{
  vtkIdType i;
  int j;
...
//	std::cout << "Quarternion "  << x  << " "  << y << " " << z << " " << w <<  std::endl;
  ...
  Translation[0] = this->Matrix->Element[0][3];
  Translation[1] = this->Matrix->Element[1][3];
  Translation[2] = this->Matrix->Element[2][3];
...
//------------------------------------------------------------------------
vtkMTimeType vtkLandmarkTransformDirectQuart::GetMTime()
{
...
//------------------------------------------------------------------------
void vtkLandmarkTransformDirectQuart::SetSourceLandmarks(vtkPoints *source)
{
...
//------------------------------------------------------------------------
void vtkLandmarkTransformDirectQuart::SetTargetLandmarks(vtkPoints *target)
{
...
//----------------------------------------------------------------------------
void vtkLandmarkTransformDirectQuart::Inverse()
{
...
//----------------------------------------------------------------------------
vtkAbstractTransform *vtkLandmarkTransformDirectQuart::MakeTransform()
{
  return vtkLandmarkTransformDirectQuart::New(); 
}

//----------------------------------------------------------------------------
void vtkLandmarkTransformDirectQuart::InternalDeepCopy(vtkAbstractTransform *transform)
{
  vtkLandmarkTransformDirectQuart *t = (vtkLandmarkTransformDirectQuart *)transform;
